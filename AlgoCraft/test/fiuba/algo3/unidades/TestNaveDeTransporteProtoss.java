...
public class TestNaveDeTransporteProtoss extends TestUnidadTransporte {
	...
	public void testNoPuedeAlmacenarPasadoSuCapacidadMaxima() {
		for (int i = 0; i < capacidad; i += 2){
			Unidad pasajeroCosto2 = new Unidad(this.jugador, POSICION_B, jugador.getAtributos().getInfanteriaLivianaTerrestre());
			unidad.almacenarA(pasajeroCosto2);
		}
		Unidad pasajeroCosto2 = new Unidad(this.jugador, POSICION_B, jugador.getAtributos().getInfanteriaLivianaTerrestre());
		assertFalse(unidad.puedeAlmacenarA(pasajeroCosto2));
	}
	...
	public void testAlmacenarPasadoSuCapacidadMaximaLanzaExcepcion() {
		...
		Unidad pasajeroCosto4 = new Unidad(this.jugador, POSICION_B, jugador.getAtributos().getInfanteriaPesadaTerrestre());
		unidad.almacenarA(pasajeroCosto4);
	}
